...
@section('content')
<form class="forms-sample" method="POST" action="{{ route('dashboard.profile.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-12">
            @if ($errors->any())
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" required
                                    name="name" id="name" placeholder="@lang('UserName')" value="{{ old('name', auth()->user()->name) }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control {{ $errors->has('country') ? ' is-invalid' : '' }}"
                                    ...
                                    <option value="Morocco" {{ old('country', auth()->user()->country)==="Morocco" ? 'selected="selected"' : '' }}>@lang('Morocco')</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" required
                                    name="city" id="city" placeholder="@lang('City')" value="{{ old('city', auth()->user()->city) }}">
                                @if ($errors->has('city'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" required
                                    name="zip_code" id="zip_code" placeholder="@lang('Zip Code')" value="{{ old('zip_code', auth()->user()->zip_code) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control {{ $errors->has('gender') ? ' is-invalid' : '' }}"
                                    ...
                                    <option value="female" {{ old('gender', auth()->user()->gender)==="female" ? 'selected="selected"' : '' }}>@lang('Female')</option>
                                    <option value="male"   {{ old('gender', auth()->user()->gender)==="male"   ? 'selected="selected"' : '' }}>@lang('Male')</option>
                                </select>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="input-file input-file-image text-center">
                                @if ( auth()->user()->avatar )
                                    <img  alt="{{ auth()->user()->first_name }} {{ auth()->user()->last_name}}" class="img-upload-preview img-circle mx-auto"
