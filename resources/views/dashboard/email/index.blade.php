...
<div class="page-header">
    <h4 class="page-title">@lang('Email Update')</h4>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form class="forms-sample" method="POST" action="{{ route('dashboard.email.store') }}">
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label for="email" class="col-form-label">@lang('New Email')*</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label for="email_confirmation" class="col-form-label">@lang('New Email Confirmation')*</label>
