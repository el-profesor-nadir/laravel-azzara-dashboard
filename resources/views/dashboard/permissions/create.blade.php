...
<div class="page-header">
    <h4 class="page-title">@lang('Create new permission')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">
                            @lang('Create new permission')</span>
                        </div>
                ...
                <form class="forms-sample" method="POST" action="{{ route('dashboard.permissions.store') }}">
                    @csrf
                    <div class="card-body">
                                ...
                                @foreach ($roles as $role)
                                    ...
                                    <div class="custom-control custom-checkbox d-block">
                                        <input class="custom-control-input {{ $errors->has('roles') ? ' is-invalid' : '' }}" type="checkbox" value="{{ $role->id }}"
                                            name="roles[]" id="{{ $role->name }}" {{ in_array($role->id, old('roles', [])) ? 'checked' : '' }}>
